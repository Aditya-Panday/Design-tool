...
const PricingCard = ({
  ...
  const handlePopup = async () => {
    ...
    if (!user) {
      toast.error("Please log in to continue."); // Show error toast
    ...
    try {
      if (window.Clerk && window.Clerk.__internal_openCheckout) {
        ...
        console.log("Opening checkout..."); // Log the actio
      ...
      toast.error("An error occurred while opening the checkout.");
    }
  };
...
const PricingSection = () => {
  const plans = [
    ...
    },
    {
      ...
      featured: true,
      planId: "cplan_30drxhmi8Ylm5c2z6j6RFptFsA2",
